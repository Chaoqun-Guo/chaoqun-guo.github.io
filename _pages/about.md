...
- CCF-Tencent "Rhino Bird" Fund Project: Research on Attack Detection Based on Attack Traceability Graphs, 2022-2023, Participant

# 📖 Educations

- _2020.09 - Present_, Ph.D. Candidate, Software Engineering, School of Software Engineering, Beijing Jiaotonng University.
- _2018.09 - 2020.06_, Master's Degree, Software Engineering, School of Information Engineering, Capital University of Economics and Business.
- _2014.09 - 2018.06_, Bechelor's Degree, E-commerce, School of E-commerce and Logistics Management, Henan University of Economics and Law.
...
<!-- | Category                               | Details                                                                                                                       |
| -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **Programming Languages & OS**         | Python, Shell, Linux.<br>Version Control Workflow: Git, GitHub.                                                               |
| **Data Analysis & ML/DL**              | Proficient with Pandas and NumPy.<br>Experienced with Scikit-Learn, TensorFlow, PyTorch.                                      |
| **Project Management & Collaboration** | Proficient with JIRA for planning, execution, and coordination.<br>Familiar with Confluence and Microsoft Teams.              |
| **Tools & Frameworks**                 | Proficient with VS Code and PyCharm.<br>Knowledgeable in Docker, Docker-Compose, CI/CD.<br>Experienced with Django and Flask. |
| **English Proficiency**                | Good reading/writing skills (CET-6 certified).                                                                                |
| **Problem-Solving**                    | Ability to analyze complex problems and propose effective solutions.                                                          |
| **Communication**                      | Clear technical communication and documentation writing.                                                                      |
| **Teamwork**                           | Effective collaboration in multidisciplinary teams, task coordination.                                                        | -->
...
- _2019.09 - 2023.03_, [Lenovo AI Lab](https://research;lenovo.com/), Beijing, China.
  ...
  - **Finance Web Scraper and Email Push Service. [Project Leader]**
